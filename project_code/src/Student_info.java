...
public class Student_info extends JFrame {
	...
	public Student_info() {
		...
		nameList = new ArrayList<String>(); nameList.add("ramesh");nameList.add("harsh");nameList.add("sanjay"); nameList.add("tanish");
		passList = new ArrayList<String>();  passList.add("123"); passList.add("123"); passList.add("123"); passList.add("123");
		idList = new ArrayList<String>(); idList.add("iit2021093"); idList.add("iit2021256");idList.add("iit2021091"); idList.add("iit2021225");
