...
public class Home extends JFrame {
	...
	public Home() {
		...
		JButton btnNewButton_1 = new JButton("Admin");  // admin button
		...
		JButton btnNewButton_2 = new JButton("Exit");   //exit button
		...
		JButton btnNewButton = new JButton("Student");   // student button 
